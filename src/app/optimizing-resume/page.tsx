    ...
    <div>
      ...
      <Card className="shadow-primary/50 shadow-lg">
        ...
        <CardContent className="flex flex-col gap-5">
          ...
          <h4>'...using...'</h4>
          <h2>Contexto:</h2>
          <h3>"Proactive and growth-focused Junior Front-End Developer with solid hands-on experience developing web applications using JavaScript, CSS, HTML, and the React ecosystem."</h3>
          <h2>🚀 Sugestão ATS:</h2>
