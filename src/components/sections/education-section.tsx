...
export function EducationSection() {
  ...
  const [openEducation, setOpenEducation] = useState<Record<number, boolean>>({
    0: true,
    1: true,
    2: true,
    3: true,
  ...
  return (
    <CardContent id="education" className="scroll-mt-20">
      ...
      >
        ...
        {/* NÍVEL 1 CONTEÚDO (LISTA DE FORMAÇÕES) */}
        <CollapsibleContent className="space-y-4">
          {cvData.education.map((edu, index) => {
            const parsed = parseEduString(edu);
            const isEduOpen = openEducation[index] ?? true;
            ...
            return (
              <Collapsible
                ...
                open={isEduOpen}
                onOpenChange={(val) =>
                  setOpenEducation((prev) => ({ ...prev, [index]: val }))
                }
              ...
              >
                ...
                {/* NÍVEL 2 CONTEÚDO (CAMPOS DA FORMAÇÃO) */}
                <CollapsibleContent className="space-y-6">
                  <div className="flex w-full flex-col gap-6">
                    {/* === PART 1: EDUCATION NAME === */}
                    <div className="flex w-full flex-col gap-2">
                      {/* TEXTAREA (Course/School Name) */}
                      <Textarea
        ...
        {/* ADD ITEM BUTTON (No final do CollapsibleContent principal) */}
        <div className="mt-2 flex justify-end">
          <Button
            type="button"
            variant="outline"
